...
![VBD Hub Home screen](images/homescreen.png "alt text")
...
![VBD Hub Search](images/finddata.png "alt text")
...
![VBD Hub About page](images/about.png "alt text")
...
![VBD Hub Resources](images/resources.png "alt text")
...
![VBD Hub Community](images/community.png "alt text")
...
Let’s break this down so we can understand what each argument does:
...
``` {r}
aedes_aegypti_data <- search_hub("Aedes aegypti") |>
 filter_db("vt") |>
 fetch() |>
 glean()
```
